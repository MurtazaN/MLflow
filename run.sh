...
echo "=========================================="
python3 run_pipeline.py 2>pipeline.log

# 4. Serve the production model and run real-time inference
echo ""
echo "Starting model server on port 5001..."
export MLFLOW_TRACKING_URI=http://127.0.0.1:5000
mlflow models serve -m "models:/wine_quality/production" -p 5001 --env-manager=local > model_server.log 2>&1 &
MODEL_PID=$!
sleep 10
...
echo "Logs:      pipeline.log, mlflow_ui.log"
